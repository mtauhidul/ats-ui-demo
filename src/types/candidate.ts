import type { Address, Attachment, BaseEntity } from './common'
...
export interface CandidatePipeline {
  ...
  // Stage transition history — one entry per move
  stageHistory?: Array<{
    fromStageId: string | null
    fromStageName: string
    toStageId: string
    toStageName: string
    changedAt: Date | { seconds: number; nanoseconds?: number }
    changedBy: string
    notes?: string
  }>
...
export interface Candidate extends BaseEntity {
  ...
  assignedTo?:
    ...
    | null // Assigned team member - can be User ID string or populated User object from backend
